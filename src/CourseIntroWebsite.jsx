...
const highlightImages = [
  {
    src: "https://i.ibb.co/CK8CrBPL/Chat-GPT-Image-2026-5-20-04-31-56-4.png",
    alt: "符合資格免費課程亮點",
    title: "符合資格免費",
  },
  {
    src: "https://i.ibb.co/nTc2G0y/Chat-GPT-Image-2026-5-20-04-31-56-3.png",
    alt: "冷氣教室課程亮點",
    title: "冷氣教室",
  },
  {
    src: "https://i.ibb.co/LDN5ThjK/Chat-GPT-Image-2026-5-20-04-31-56-2.png",
    alt: "專業設備課程亮點",
    title: "專業設備",
  },
  {
    src: "https://i.ibb.co/CKPJ6b7K/Chat-GPT-Image-2026-5-20-04-31-56-1.png",
    alt: "結訓輔導就業課程亮點",
    title: "結訓輔導就業",
  },
];
...
const curriculumImages = [
  {
    src: "https://i.ibb.co/CK8B4JRY/Chat-GPT-Image-2026-5-20-04-05-19-3.png",
    alt: "餐飲料理課程內容",
    title: "餐飲料理",
  },
  {
    src: "https://i.ibb.co/x8J2ffFx/Chat-GPT-Image-2026-5-20-04-05-19-2.png",
    alt: "烘焙甜點課程內容",
    title: "烘焙甜點",
  },
  {
    src: "https://i.ibb.co/Q7mskHw6/Chat-GPT-Image-2026-5-20-04-05-18-1.png",
    alt: "品牌行銷課程內容",
    title: "品牌行銷",
  },
];
      ...
      <header className="sticky top-0 z-40 border-b border-orange-100 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden items-center gap-7 text-sm font-semibold text-stone-600 lg:flex">
            ...
            <a href="#career" className="hover:text-stone-950">就業方向</a>
          </nav>
      ...
      <main id="top">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-16 md:grid-cols-[1.05fr_0.95fr] md:py-24">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              ...
              <p className="mt-6 max-w-2xl text-xl leading-9 text-stone-700">
                免費上課、冷氣教室、專業設備實作。學餐飲、做烘焙、練行銷，也協助準備中餐丙級＋烘焙丙級考試方向。
              </p>
              ...
              <Card className="overflow-hidden rounded-[2rem] border-orange-100 bg-white shadow-2xl">
                <div className="relative aspect-[4/3] overflow-hidden bg-stone-950">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 rounded-3xl bg-stone-950/80 p-5 text-white backdrop-blur">
                    ...
                    <p className="mt-1 text-2xl font-black">中餐丙級＋烘焙丙級</p>
                  </div>
                </div>
        ...
        <section id="highlights" className="mx-auto max-w-7xl px-6 py-20">
          <div className="max-w-3xl">
            ...
            <h2 className="text-4xl font-black tracking-tight md:text-5xl">報名前你最該知道的三件事</h2>
        ...
        <section id="curriculum" className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-6">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-lg leading-8 text-stone-600">三張圖快速看懂課程內容。</p>
            </div>
        ...
        <section id="career" className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-6">
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
              <div>
                <p className="mb-3 text-sm font-black uppercase tracking-[0.24em] text-orange-700">Career</p>
                <h2 className="text-4xl font-black tracking-tight md:text-5xl">結訓後可以做什麼</h2>
              </div>
              <div className="grid gap-4">
                {jobs.map((job) => (
                  <div key={job} className="flex gap-4 rounded-3xl border border-stone-200 bg-stone-50 p-5">
                    <CheckCircle2 className="mt-1 shrink-0 text-orange-600" size={22} />
        ...
        <section className="mx-auto max-w-5xl px-6 py-20">
          <div className="mb-8 grid gap-4 md:grid-cols-3">
            <MiniNote title="報名截止" text="06/15 下午 5:00" />
            <MiniNote title="甄試時間" text="06/17 早上 9:00" />
            <MiniNote title="上課地點" text="埔里鎮隆生路 99 號" />
          </div>
...
function MiniNote({ title, text }) {
  return (
    <div className="rounded-3xl border border-orange-100 bg-white p-5 text-center shadow-sm">
      <p className="text-sm font-black text-orange-700">{title}</p>
      <p className="mt-1 text-xl font-black text-stone-950">{text}</p>
    </div>
  );
}
